...
extension Result {
    public func mapBoth<NewSuccess, NewFailure>(ifSuccess: (Success) -> NewSuccess, ifFailure: (Failure) -> NewFailure ) -> Result<NewSuccess, NewFailure> {
    ...
    public func flatMapBoth<NewSuccess, NewFailure>(ifSuccess: (Success) -> Result<NewSuccess, NewFailure>, ifFailure: (Failure) -> Result<NewSuccess, NewFailure>) -> Result<NewSuccess, NewFailure> {
